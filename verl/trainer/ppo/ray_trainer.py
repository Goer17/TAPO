...
def compute_response_mask(data: DataProto):
    responses = data.batch["responses"]
    response_length = responses.size(1)
    # assert "info_mask" in data.batch
    response_mask = data.batch["attention_mask"] if "info_mask" not in data.batch else data.batch["info_mask"]
    return response_mask[:, -response_length:]
